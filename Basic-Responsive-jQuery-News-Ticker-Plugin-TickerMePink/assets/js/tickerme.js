...
(function($){
	...
	$.fn.tickerme = function(options) {
		...
		return this.each(function(){
			...
			var control_styles = '<style type="text/css">#ticker_container{width:100%}#newscontent{float:right}#news{display:none}#controls{float:left;height:16px}.icon{display:inline-block;width:16px;height:16px;fill:'+opts.control_colour+'}.icon:hover{fill:'+opts.control_rollover+'}</style>';
