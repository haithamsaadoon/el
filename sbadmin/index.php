                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            لوحة التحكم <small>احصائيات مختصرة</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> مخطط نسب النجاح خلال السنوات الماضية</h3>
                            </div>
