...
أضافة خبر                            </li>
                ...
                <!-- /.row -->
                <form role="form" class="form-inline" method="post" action="addnewshandler.php" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="title" type="text" class="form-control" id="first" placeholder="عنوان الخبر">
                                    </div>
                            ...
                            <br/>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="short" type="text" class="form-control" id="first" placeholder="وصف مختصر">
                                    </div>
                            <br/>
                            <br/>
                                    <div class="input-group">
                                       
                                        <textarea name="detail" cols="50" rows="10" placeholder="تفاصيل الخبر"></textarea>
                                    </div>
                                    
                            
                            <br/>
                            <br/>
                            <label>صورة الخبر</label> <input type="file" name="newsimg" />
                            <br/>
                            <br/>
