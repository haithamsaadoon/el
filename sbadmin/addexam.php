...
أضافة امتحان                            </li>
                ...
                <!-- /.row -->
                <form role="form" class="form-inline" method="post" action="addexamhandler.php" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="title" type="text" class="form-control" id="first" placeholder="عنوان الامتحان ">
                                    </div>
                            <br/><BR/>
                                     <div class="input-group">
                                       
                                        <span class="input-group-addon">عدد الاسئلة ذات الاجابة الواحدة</span>
                                        <input name="nos" type="number" class="form-control" id="first" placeholder="ادخل العدد هنا ">
                                    </div>
                                     <div class="input-group">
                                       
                                        <span class="input-group-addon">عدد الاسئلة ذات الاجابات المتعددة</span>
                                        <input name="nom" type="number" class="form-control" id="first" placeholder="ادخل العدد هنا ">
                                    </div>
                            ...
                            <br/>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">تاريخ بداية الامتحان</span>
                                        <input style="direction: ltr;text-align: center" name="start" type="text" class="form-control" id="start" >
                                    </div>
                            <br/>
                             <br/>
                                     <div class="input-group">
                                        <span class="input-group-addon">تاريخ نهاية الامتحان</span>
                                        <input style="direction: ltr;text-align: center" name="end" type="text" class="form-control" id="end" >
                                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-users"></i> قائمة الاخبار</h3>
                            </div>
                                        ...
                                        <thead>
                                            <tr>
                                                <th>الرقم الرمزي 
                                                    ...
                                                    (لاضافة اسئلة للامتحان ) </th>
                                                <th>عنوان الامتحان</th>
                                                <th>تاريخ بدأ الامتحان</th>
                                                <th>تاريخ اغلاق الامتحان</th>
